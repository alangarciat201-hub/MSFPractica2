...
plt.plot(t,Pp1,'-',linewidth=1,color=[0.50,0.11,0.57],label='Pp(t): Hipotenso')
plt.plot(t,Pp2,'-',linewidth=1,color=[0.30,0.41,0.7],label='Pp(t): Hipertenso')
plt.grid(False)
...
# SUBPLOT (a): Normotenso vs Hipotenso 
...
# SUBPLOT (b): Normotenso vs Hipertenso 
